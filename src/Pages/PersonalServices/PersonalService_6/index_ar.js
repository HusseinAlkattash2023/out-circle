...
import image from '../../../Assets/images/personal_service-ar/image6.png'
const PersonalServiceAr_6 = () => {
  return (
    <div>
        <MessageAr 
        ...
        text2={"توفير خدمة الدفع الألكتروني للضرائب والرسوم ومخالفات السير وأي رسم الكتروني"}
        text3={"...."}
        text4={"...."}
        text5={"...."}
        text6={"...."}
...
export default PersonalServiceAr_6;