      ...
      <section className="main">
        ...
        <div className="text_ar">
          ...
          <ul dir="rtl">
            ...
            <li>
              <p>خدماتنا المهنية والشخصيةتحتاج لدراسة ممنهجة ودقيقة لقبولها لذا يرجى طلبها مع إتاحة الوقت الكافي لتجنب أي إشكال قد يحدث حيث إنه يوجد احتمال عدم تلبيتها</p>
            </li>
            <li>
